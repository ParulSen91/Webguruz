...
class WPVideosForPostsWidget extends WP_Widget
{
        ...
        function form($instance){
                $instance = wp_parse_args((array) $instance, array('title'=> '','width'=>'165','height'=>'125','cat_checkbox'=>'','num_posts'=>'5','display'=>'v','display_type'=>'th','post_title'=>'yes','author'=>'','position'=>'','company'=>'','excerpt'=>'yes','excerpt_length'=>10));
		...
		//	print_r($instance);
			...
			<p>
                        ...
                        <p>
			<input type="checkbox" name="<?php echo $this->get_field_name('position');?>" value="yes" <?php if($instance['position']=='yes'){ echo 'checked="checked"';};?>/> <?php _e('Display Position');?>
			</p>
                        <p>
			<input type="checkbox" name="<?php echo $this->get_field_name('company');?>" value="yes" <?php if($instance['company']=='yes'){ echo 'checked="checked"';};?>/> <?php _e('Display Company');?>
			</p>
			<p>
