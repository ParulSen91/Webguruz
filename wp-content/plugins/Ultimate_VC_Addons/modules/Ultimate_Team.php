	...
	class Ultimate_Team{
		...
		function ult_team_shortcode($atts, $content){
			...
			if ( $team_member_style == 'style-3' ) {
				...
				echo '<div class="ult-team-member-image ' . $id . '" style="'. esc_attr( $team_image_style ).'; background-color:' . $team_img_bg_color. '" data-hover_opacity="' . $team_img_hover_opacity_style3 . '" > <img class="'. $team_img_grayscale_cls. '" src="' .apply_filters('ultimate_images', esc_url( $img ))  . '" alt="'.$name.'" >';
