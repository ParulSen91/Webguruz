...
<div class="entry-author wf-table">
	...
	<?php	
	$editors = get_users('user_id=3&role=editor' );
 	foreach( $editors as $user ) {
 	echo "<div class='wf-td entry-author-info'>";

 	echo get_avatar( $user->ID); 
		echo "<p class='text-normal'>". $user->description ."</p>";
	}
?>
</div>
</div>
       ...
       <?php comments_template( '', true ); ?>
          <div id="single-subscription-form" class="wrapborder clearfix">'
     
     <h2><span>Subscribe us to keep yourself updated</span></h2>
