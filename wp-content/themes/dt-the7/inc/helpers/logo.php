...
if ( ! function_exists( 'presscore_display_the_logo' ) ) :
	...
	//	echo '<a href="' . esc_url( $url ) . '">' . $logo . '</a>';
		//$url="http://202.164.49.132:4040/webguruz/wp-content/uploads/2016/08/about-lap.jpg";
if (is_front_page())
{
$w_url = site_url();
$logow= $w_url."/wp-content/uploads/2016/08/logo.png";

}
else
{
$w_url2 = site_url();	
$logow=$w_url2."/wp-content/uploads/2016/08/logo-inner.png";

}


		$logo='<img class="preload-me" src="' .$logow. '" width="243" height="94" sizes="243px" alt="webguruz">';

	//	echo '<a href="' . esc_url( $url ) . '"> <img class=" preload-me" src="' .$logow. '"" width="243" height="94" sizes="243px" alt="webguruz"></a>';
	echo '<a href="' . esc_url( $url ) . '">' . $logo . '</a>';
	}
