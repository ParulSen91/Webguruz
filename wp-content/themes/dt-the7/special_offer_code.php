...
if ('1'=='1')
{
	...
	//$service = $_REQUEST['service']; //= implode(',',$servicevalues);
	 if($promocode){
	 	$promo_msg=' You will get the discounted offers! ';
	...
	$file = $filename;
	$isd_phone =$isd."-".$phone; 
	$sql = "INSERT INTO quote (refference,name,email,phone,skype_id,website,est_budget,des,service,file,promocode) VALUES ('$refference','$name','$email','$isd_phone','$skype_id','$website','$est_budget','$des','$servicevalues','$file','$promocode')";
	...
	if (mysqli_query($conn, $sql))
	{
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<tr>
								<td><p style="color:#606060; font-size:14px; padding-bottom:10px; line-height:21px; font-family:Arial, Helvetica, sans-serif;">You have signed up with us for the '.$servicevalues.'. We will surely give you services better than you would have expected. We will get back to you within 48 hours.'.$promo_msg.'</p></td>
							</tr>
						...
						$message2 .='</tr>';
						$message2 .='<tr>';
						$message2 .='<td height="40" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; text-align:left; font-weight:normal; background:#e8e8e8; padding-left:15px; border-right:1px solid #acacac; border-left:1px solid #acacac;"><strong>Refference:</strong></td>';
						...
						$message2 .='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; text-align:left; font-weight:normal; padding-left:15px; padding-top:15px; border-bottom:1px solid #acacac; border-right:1px solid #acacac; padding-bottom:15px;">'.$des.'</td>
							...
							$message2 .='<tr>';
						$message2 .='<td height="40" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; text-align:left; font-weight:normal; padding-left:15px; border-right:1px solid #acacac; padding-top:15px; border-left:1px solid #acacac; border-bottom:1px solid #acacac; padding-bottom:15px;"><strong>Promocode Apply:</strong></td>';
						$message2 .='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; text-align:left; font-weight:normal; padding-left:15px; padding-top:15px; border-bottom:1px solid #acacac; border-right:1px solid #acacac; padding-bottom:15px;">'.$promocode.'</td>
							</tr>';
						$message2 .='</table>';
						$message2 .='</div>';
						$message2 .='</td>';
