...
<div class="project-list-media<?php echo esc_attr( $media_wrap_class ); ?>"<?php echo $media_wrap_atts; ?>>
             <div class="portfolio-frame-head"> 
               <span class="portfolio-frame-dots"></span>
			  <span class="portfolio-addressbar"> <?php echo $project_link = presscore_get_project_link_img( 'project-link' ); ?></span>
               <span class="portfolio-frame-lines"></span> 
               </div>
